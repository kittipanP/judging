...
<?php
    ...
    mysqli_select_db($MyConnect, $database_MyConnect);
      ...
      WHERE (contestant.type_contest_typ_id = 3) AND (committee.judger = $judger)
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">
        <div class="w3-container w3-card-2 w3-white w3-round w3-margin" id="onProcess">
                      <h2>Quality [DL and Technician]  </h2>
                    ...
                    <table class="w3-table-all w3-margin-top w3-hoverable " id="onProcessiiTable" >
                        ...
                        <?php do { ?>
                            <tr>
                              ...
                              ?>
                              <td><?php echo $row_studentSet['con_id']-9; ?></td>
                              <td>
                  ...
                  onclick="onClick(this)" class="w3-hover-opacity">
                              ...
                              ?>
                                ...
                                <td><a class="w3-button w3-grey w3-round-large w3-hover-blue" href="evaQlyDL-Tech.php?con_id=<?php echo $row_studentSet['con_id']; ?>"><i class="fa fa-pencil"></i></a></td>
                              <?php
                              }else{
                              ?>
